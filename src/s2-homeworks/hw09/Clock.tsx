...
function Clock() {
    ...
    //const stringTime = date?.toLocaleTimeString().split(":", 2).join(':')  (.slice(0,-3)) || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты

    const stringTime = new Intl.DateTimeFormat('ru', {
        hour: 'numeric',
        minute: 'numeric',
        second: 'numeric'
    }).format(date).slice(0,-3) || <br/>// часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
